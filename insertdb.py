...
def main():
    ...
    extracted_path = "data/extracted/" "extracted_products.json"
    ...
    print(f"Loaded " f"{len(extracted_products)} " f"extracted products")

    # Run cleaner
    cleaned_products = clean_products(extracted_products)

    print(f"Cleaned " f"{len(cleaned_products)} " f"products")
